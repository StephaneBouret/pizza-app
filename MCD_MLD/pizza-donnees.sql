...
-- ============= INGREDIENTS =============
INSERT INTO ingredient (name, unit, isVegetarian, isVegan, hasAllergens) VALUES
('Tomates San Marzano', 'GRAM', 1, 1, 0),
('Parmigiano Reggiano DOP', 'GRAM', 1, 0, 1),
('Fior di latte', 'GRAM', 1, 0, 1),
('Spianata piccante', 'GRAM', 0, 0, 0),
('Ricotta fraîche', 'GRAM', 1, 0, 1),
('Oignons confits', 'GRAM', 1, 1, 0),
('Poivrons doux séchés', 'GRAM', 1, 1, 0),
('Taleggio DOP', 'GRAM', 1, 0, 1),
('Gorgonzola', 'GRAM', 1, 0, 1),
('Fior di latte fumé', 'GRAM', 1, 0, 1),
('Miel à la truffe', 'GRAM', 1, 0, 0),
('Tomates datterini', 'GRAM', 1, 1, 0),
('Pesto de basilic', 'GRAM', 1, 0, 1),
('Grana Padano', 'GRAM', 1, 0, 1),
('Basilic', 'GRAM', 1, 1, 0),
('Base blanche Fior di latte', 'GRAM', 1, 0, 1),
('Tomates confites', 'GRAM', 1, 1, 0),
('Aubergines frites', 'GRAM', 1, 1, 0),
('Ricotta salée', 'GRAM', 1, 0, 1),
('Bufala', 'GRAM', 1, 0, 1),
('Provolone', 'GRAM', 1, 0, 1),
('Jambon de Parme 24 mois', 'GRAM', 0, 0, 0),
('Sauce tomate jaune', 'GRAM', 1, 1, 0),
('Mozzarella di Bufala', 'GRAM', 1, 0, 1),
('Amandes grillées', 'GRAM', 1, 1, 1),
('Confiture de figues', 'GRAM', 1, 1, 0),
('Champignons de Paris sautés', 'GRAM', 1, 1, 0),
('Jambon cuit Gran Biscotto', 'GRAM', 0, 0, 0),
('Persil', 'GRAM', 1, 1, 0),
('Olives taggiasche', 'GRAM', 1, 1, 0),
('Anchois de Santoña', 'GRAM', 0, 0, 0),
('Câpres de Pantelleria', 'GRAM', 1, 1, 0),
('Filets de thon à l''huile d''olive', 'GRAM', 0, 0, 0),
('Sauce tomate San Marzano cuite 4h', 'GRAM', 1, 1, 0),
('Noisettes', 'GRAM', 1, 1, 1),
('Provola fumée', 'GRAM', 1, 0, 1),
('Crème', 'ML', 1, 0, 1),
('Jambon speck', 'GRAM', 0, 0, 0),
('Mozzarella Casa Azzurra', 'GRAM', 1, 0, 1),
('Stracciatella', 'GRAM', 1, 0, 1),
('Crème de truffe', 'ML', 1, 0, 1),
('Truffe fraîche', 'GRAM', 1, 1, 0),
('Origan', 'GRAM', 1, 1, 0),
('Ail', 'GRAM', 1, 1, 0),
('Chips de courgettes', 'GRAM', 1, 1, 0),
('Fleurs de courgettes', 'GRAM', 1, 1, 0),
('Crème de Provolone', 'ML', 1, 0, 1),
('Crème de courgettes', 'ML', 1, 1, 0),
('Noix', 'GRAM', 1, 1, 1),
('Sauce tomate', 'ML', 1, 1, 0);
